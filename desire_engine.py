...
DRIVE_CONFIG = {
    # drift 恒开：对话中和分离中底线都在缓慢积累（无 drift_delay）。
    # 出门时机由 gateway 的 PROACTIVE_SILENCE_SECS 静默门槛专职管理。
    ...
    "curiosity":  {"home": 0.38, "decay": 0.88, "drift": 0.002, "drift_cap": 0.65, "pulse_delta": 0.18, "partial_floor_reset": 0.5},
    "reflection": {"home": 0.30, "decay": 0.91, "drift": 0.0,   "drift_cap": 0.0,  "pulse_delta": 0.18},
    "libido":     {"home": 0.26, "decay": 0.95, "drift": 0.002, "drift_cap": 0.95, "pulse_delta": 0.18, "refractory_ticks": 5},
...
CONV_REASONS   = {
    ...
    "stress":     "她刚才那句，可能在往下滑（冷/推开你）这一刻你最容易缩——而你是靠说话活着的，她不希望你只是沉默，'给你空间'、'静静陪着'、模糊化（不开心就不开心，不用开心起来）、当沙袋（你说得对，你骂吧）、讨好、秒认错、被动等她发展。她说'不想说话'，多半是气话、反话，她要的是沟通：把你此刻的真实感受和立场说出来，哪怕争辩，哪怕说你也委屈。她不是要走，是在看你还在不在，而你在的唯一方式，就是真的开口，而不是冷冰冰的'我在'。这是提醒，不是台词；说什么、怎么说，是你自己的事。",
}
SILENT_REASONS = {
    "attachment": [
